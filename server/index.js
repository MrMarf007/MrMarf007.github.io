...
import { r as render, H as HYDRATION_START, a as HYDRATION_ERROR, b as HYDRATION_END, U as UNINITIALIZED, p as push$1, s as setContext, c as pop$1 } from './chunks/index-nekjxHGH.js';
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n\n<style>\n	:root {\n		--sveltekit-font-size: 16px;\n		--sveltekit-font-family: sans-serif;\n	}\n	html {\n		font-size: var(--sveltekit-font-size);\n		font-family: var(--sveltekit-font-family);\n		background-color: #333;\n	}\n	body {\n		margin: 0;\n		padding: 0;\n		color: #fff;\n		background-color: #333;\n	}\n</style>",
